...
7. Your database is currently blank. Install database schema by running `./data/db_2024_10_10.sql` and any updates greater than `0006`.
...
5. Install database schema by running `./data/db_2024_10_10.sql` and any updates greater than `0008`
